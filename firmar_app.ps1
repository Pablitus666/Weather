...
if (-not (Test-Path $pfxFile)) {
    ...
    try {
        ...
        # Exportamos usando una contraseña temporal en texto plano para el comando de exportación
        ...
        # Opcional: Eliminar del almacen personal después de exportar para mantenerlo limpio
